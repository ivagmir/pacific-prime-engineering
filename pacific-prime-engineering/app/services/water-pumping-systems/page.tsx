...
<FadeIn>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mb-12 text-xl leading-8 text-slate-300">
          Our team specializes in the assessment, design support, troubleshooting, optimization 
          and maintenance of critical water pumping infrastructure, including booster pump systems, 
          transfer pumps, circulation systems, pressure management equipment and water distribution 
          networks. We help hospitality properties maintain dependable water supply, improve system 
          efficiency and reduce operational risks associated with equipment failures or service 
          interruptions.
        </p>
        <p className="mb-12 text-xl leading-8 text-slate-300">
          Through a proactive engineering approach focused on reliability, performance and operational 
          resilience, we deliver solutions that support uninterrupted water service in environments 
          where guest satisfaction and operational excellence are paramount. Whether addressing system 
          performance issues, planning infrastructure improvements or responding to urgent operational 
          challenges, Pacific Prime Engineering provides professional engineering support tailored 
          to the demands of premium hospitality operations.
        </p>
        ...
        <div className="glass-card rounded-[2rem] p-10">
          ...
          <ul className="space-y-4 text-slate-300">
            ...
            <li>• Water pumping system assessments</li>
            <li>• Pump performance diagnostics</li>
            <li>• Preventive maintenance programs</li>
            <li>• Booster systems optimization</li>
            <li>• Pressure system reliability</li>
            <li>• Infrastructure reliability evaluations</li>
