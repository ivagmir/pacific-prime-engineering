...
export const metadata = {
  title: "Building Maintenance & Repairs in Guanacaste | Pacific Prime Engineering",
  description:
    "Premium building maintenance and repair services for luxury resorts, villas and hospitality infrastructure in Guanacaste, Costa Rica.",
};

export default function BuildingMaintenanceRepairsPage() {
  return (
